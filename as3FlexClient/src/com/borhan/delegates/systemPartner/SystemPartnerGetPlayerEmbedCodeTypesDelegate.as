...
{
	import com.borhan.vo.BorhanPlayerEmbedCodeType;BorhanPlayerEmbedCodeType;;
	...
	{
		public function SystemPartnerGetPlayerEmbedCodeTypesDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
