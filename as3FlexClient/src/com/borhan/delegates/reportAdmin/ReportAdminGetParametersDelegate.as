...
// @ignore
// ===================================================================================================
package com.borhan.delegates.reportAdmin
{
	import com.borhan.vo.BorhanString;BorhanString;;
	...
	{
		public function ReportAdminGetParametersDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
