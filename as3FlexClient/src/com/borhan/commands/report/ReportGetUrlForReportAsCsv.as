...
package com.borhan.commands.report
{
	...
	public class ReportGetUrlForReportAsCsv extends BorhanCall
	{
		 ...
		 **/
		public function ReportGetUrlForReportAsCsv( reportTitle : String,reportText : String,headers : String,reportType : int,reportInputFilter : BorhanReportInputFilter,dimension : String = null,pager : BorhanFilterPager=null,order : String = null,objectIds : String = null )
		{
			service= 'report';
